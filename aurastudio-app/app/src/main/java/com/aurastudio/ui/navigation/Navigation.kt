package com.aurastudio.ui.navigation
...
val bottomNavItems = listOf(
    ...
    NavItem(R.string.nav_create_project, Icons.Rounded.Add, Icons.Rounded.Add, Screen.CreateProject.route, isCreateButton = true),
